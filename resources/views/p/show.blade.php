    ...
    <div class="row">
      <div class="col-md-9">
        <div class="blog-grid margin-bottom-30">
          ...
          <img class="img-responsive" src="{{ voyager::image($post->image)}}" alt="Gambar">
        </div>
        <p>
                {!! $post->body !!}
        ...
        <div class="margin-bottom-50">
          ...
          <div class="row blog-comments-v2">
            <div class="commenter">
              <img class="rounded-x" src="{{ Voyager::image($comment->author->avatar) }}" alt="">
            </div>
        ...
        @if (Auth::guest())
          ...
          @else
            <h2 class="title-v4">Post a Comment</h2>
                ...
                <form class="csky-form comment-style-v2" action="/comment/add" method="post" id="sky-form3">
                  <fieldset>
        ...
        @else
          ...
          <div class="blog-thumb blog-thumb-circle margin-bottom-15">
            <div class="blog-thumb-hover">
              <img class="rounded-x img-responsive" src="{{ voyager::image($a->image)}}" alt="">
      ...
      @endif
        ...
        @else
          ...
          <div class="blog-thumb blog-thumb-circle margin-bottom-15">
            <div class="blog-thumb-hover">
              <img class="rounded-x img-responsive" src="{{ voyager::image($b->image)}}" alt="">
              <a class="hover-grad" href="{{ url('/p/'.$b->slug) }}"><i class="fa fa-link"></i></a>
            </div>
            <div class="blog-thumb-desc">
              <h3><a href="{{ url('/p/'.$b->slug) }}">{{$b ->title}}</a></h3>
              <ul class="blog-thumb-info">
                <li>{{ $b->created_at->format('M d,Y \a\t h:i a') }}</li>
              </ul>
            </div>
          </div>
        @endforeach
